    ...
    switch (currentStep) {
      ...
      case 1:
        return (
          <div className="flex flex-col space-y-4">
            <div className="flex flex-col space-y-2">
              <h1 className="text-2xl leading-none">Add your avatar</h1>
      ...
      case 4:
        return (
          <div className="flex flex-col space-y-4">
            <div className="flex flex-col space-y-2">
              <h1 className="text-2xl leading-none">What are your goals?</h1>
              <h2 className="text-md text-title-secondary">
      ...
      case 5:
        return (
          <div className="flex flex-col space-y-4">
            <div className="flex flex-col space-y-2">
              <h1 className="text-2xl leading-none">Tell us about yourself</h1>
              <h2 className="text-md text-title-secondary">
